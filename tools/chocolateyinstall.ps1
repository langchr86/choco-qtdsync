...
$url        = 'https://sourceforge.net/projects/qtdsync/files/v0.6/QtdSync_v0.6.20beta.exe/download' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'qtdsync*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
